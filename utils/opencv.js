...
//       cv = cv || {};
      ...
      function createWasm() {
        ...
        //   var wasmurl = "https://www.wechatvr.org/opencvRealese/opencv_js.wasm";
        //   var wasmfilename = wasmurl.slice(wasmurl.lastIndexOf("/") + 1);
        //   wx.downloadFile({
        //     url: "https://www.wechatvr.org/opencvRealese/opencv_js.wasm",
        //     success(evt) {        
          ...
          switch (event.type) {
            ...
            case "wheel":
              ...
              switch (event.deltaMode) {
                ...
                default:
                  throw (
                    "unrecognized mouse wheel delta mode: " + event.deltaMode
                  );
              }
              break;
            default:
      ...
      function _emscripten_futex_wake() {}
      function _emscripten_check_blocking_allowed() {}
      function _emscripten_is_main_browser_thread() {}
      function _emscripten_get_now() {}
      function _emscripten_futex_wait() {}
      ...
      function _emscripten_set_current_thread_status() {}
      ...
      function _pthread_cleanup_push(){}
      ...
      var asmLibraryArg = {
        ...
        "initPthreadsJS": _initPthreadsJS,
